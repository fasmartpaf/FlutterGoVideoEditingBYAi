...
| 2026-09-07 | dev `main` @ `7d355e7`, CLI promo slice (`npm run agent` edit+export). No computer-use MCP. | macOS 26.6, Apple Silicon | Partial — promo export only | One complete supported-feature promo on `recording-1788768223312.mp4` (8.088 s source). Applied trim 0–0.35, zoom 1.2–3.8 d3, speed 6.2–8.0 @ 1.35×, 9:16 + wallpaper 3, hook “Coach Pulse”, mosaic blur, green “Try Now” CTA. Export `.way1-e2e/fluttergo-promo-9x16.mp4`: 1080×1920 h264_videotoolbox, 437 frames, **7.283 s**. Arithmetic: 8.088 − 0.35 − 1.8×(1−1/1.35) = 7.272 s expected; +11 ms vs container, under one frame at 60 fps. Frames: 9:16 plate + wallpaper hold; CTA visible at 6.2 s; leftover `[BLANK_AUDIO]` auto-caption on this silent take; mosaic at (84,12) is a small gray patch on chrome, not a useful redact. **Skipped:** HUD, chat-driven turn, imported audio, captions-from-speech, computer-use, templates/transitions/VFX. |
|      |             |          |           |       |
|      |             |          |           |       |
